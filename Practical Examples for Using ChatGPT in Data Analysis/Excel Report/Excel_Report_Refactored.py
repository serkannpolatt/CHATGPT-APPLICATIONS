...
def load_excel_files(folder):
    ...
    """Bir klasördeki tüm Excel dosyalarını veri çerçeveleri listesine yükleyin"""
...
def combine_dataframes(dataframes):
    ...
    """Birden çok veri çerçevesini tek bir veri çerçevesinde birleştirin"""
...
def calculate_category_data(combined_data):
    ...
    """Her kategori için toplam gelir, gider ve kârı hesapla"""
...
def create_category_report(category_data, report_name):
    ...
    """Kategori verilerini özetleyen bir Excel raporu oluştur"""
...
if __name__ == '__main__':
    data_folder = Path('Excel_Report\data')
